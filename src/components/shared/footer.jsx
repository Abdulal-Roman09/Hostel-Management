...
export default function Footer() {
  ...
  return (
    <footer className="bg-orange-50 dark:bg-gray-900 text-gray-800 dark:text-gray-300 transition-colors duration-300">
      {/* Main Footer Content */}
